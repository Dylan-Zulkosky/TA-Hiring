...
//
// Persons: None
// Online Sources: I used the HiringTestingUtilities javadocs to help understnad this method
//// (https://cs300-www.cs.wisc.edu/wp/wp-content/uploads/2023/fall/p06/HiringTestingUtilities.html)
//
///////////////////////////////////////////////////////////////////////////////
...
public class HiringTestingUtilities {
  ...
  public static CandidateList bitSubset(CandidateList candidates, long bits) {
    return new CandidateList(IntStream.range(0, candidates.size())
        .filter(i -> (bits & (1L << i)) != 0).mapToObj(candidates::get).toList());
  }
  ...
  public static ArrayList<CandidateList> allOptimalSolutions(CandidateList candidates,
    ...
    List<CandidateList> options =
        LongStream.range(0, 1L << candidates.size()).filter(i -> Long.bitCount(i) == totalHires)
  ...
  public static ArrayList<CandidateList> allMinCoverageSolutions(CandidateList candidates,
      int minHours) {
    List<CandidateList> options =
        LongStream.range(0, 1L << candidates.size()).mapToObj(i -> bitSubset(candidates, i))
