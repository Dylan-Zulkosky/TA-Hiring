...
//
// Persons: None
// Online Sources: I used the CandidateList javadocs to help understand this method
///////////// (https://cs300-www.cs.wisc.edu/wp/wp-content/uploads/2023/fall/p06/CandidateList.html)
//
///////////////////////////////////////////////////////////////////////////////
...
public class CandidateList extends ArrayList<Candidate> {
   ...
   * @throws IllegalArgumentException if this list does not contain the given candidate.
   */
   ...
   * @throws IllegalArgumentException if this list already contains the given candidate.
   */
